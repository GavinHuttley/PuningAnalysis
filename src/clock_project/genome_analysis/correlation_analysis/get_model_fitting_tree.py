...
import click
from cogent3 import get_app, load_tree, open_data_store
from cogent3.app.composable import define_app
from cogent3.app.typing import SeqsCollectionType, SerialisableType
from ensembl_tui._species import Species

with open(
    "/Users/gulugulu/repos/PuningAnalysis/results/output_data/genome_information/common_names_mapping.json",
    "r",
...
def model_fitting_tree(alignment: SeqsCollectionType) -> SerialisableType:
    ...
    model = get_app(
        "model", "GN", tree=tree_topology, time_het="max", optimise_motif_probs=True
    )
    print("start")
...
@click.option(
    "-o",
    "--output_dir",
    default="/Users/gulugulu/repos/PuningAnalysis/results/output_data/model_fitting_result",
