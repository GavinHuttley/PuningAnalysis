...
matrix_collection_dir = (
    "/Users/gulugulu/Desktop/honours/data_local_2/valid_matrix_full.json"
)
ancester_seq_dir = (
    "/Users/gulugulu/Desktop/honours/data_local_2/seed_ancester_sequences.json"
)
simulated_info_dir = (
    "/Users/gulugulu/Desktop/honours/data_local_2/output_simulated_sequence"
)
...
def calculate_percentages(ancestral_seq):
    ...
    return [
        (count.get(str(i), 0) / total_count) for i in range(4)
    ]  # Assuming 0 to 3 are the keys
...
def main(comb):
    ...
    for t in [0.5, 1.0, 1.5, 2.0]:
        ...
        print(len(aln_paths))
        aln_ens_path = os.path.join(
            simulated_info_dir, f"ens_results_{pi_info}_{t}_{length}.json"
        )
    ...
    with open(
        f"/Users/gulugulu/Desktop/honours/data_local_2/simulated_aln_info_{comb}.json",
        "w",
    ) as outfile:
