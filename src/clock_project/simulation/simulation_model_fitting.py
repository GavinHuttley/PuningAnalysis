...
from cogent3.app.typing import AlignedSeqsType, IdentifierType, SerialisableType
...
def get_triads_info(path):
    ...
    jsd_dict = {
        ...
        "JSD_difference": {"ingroup_edge1": jsd1, "ingroup_edge2": jsd2},
    }
    nabla_dict = {}
    ...
    nabla_dict["outgroup_edge3"] = calculate_non_stationarity(
        distribution_root, matrices["outgroup_edge3"], ens_dict["outgroup_edge3"]
    )
    ...
    distributions = {
        ...
        "ingroup1": list(nuc_freqs1),
        "ingroup2": list(nuc_freqs2),
    }
    triad_data = {
        "triads_species_names": seq_names,
        "triads_info_small_tree": {
...
def process_path(path, output_dir):
    ...
    for datamember in triads_alignment_input_data_store:
        ...
        write_json_app = get_app(
            "write_json", data_store=out_dstore, id_from_source=get_id
        )
